...
:nocogpath
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-swift-svn.jar" goto nocogpath15
    goto cogpath
...
:found2
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-swift-svn.jar" goto nocogpath25
    goto cogpath
...
:cogpath
    ...
    java %OPTS% org.griphyn.vdl.toolkit.VDLt2VDLx %*
