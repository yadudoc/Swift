...
:nocogpath
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-grapheditor-0.47.jar" goto nocogpath15
    goto cogpath
...
:found2
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-grapheditor-0.47.jar" goto nocogpath25
    goto cogpath
...
:cogpath
    ...
    java %OPTS% org.globus.cog.gui.grapheditor.Launcher %*
