...
:nocogpath
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-abstraction-common-2.4.jar" goto nocogpath15
    goto cogpath
...
:found2
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-abstraction-common-2.4.jar" goto nocogpath25
    goto cogpath
...
:cogpath
    ...
    java %OPTS% org.globus.cog.abstraction.tools.execution.JobSubmission %*
