...
:nocogpath
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-jglobus-1.7.0.jar" goto nocogpath15
    goto cogpath
...
:found2
    ...
    if NOT EXIST "%COG_INSTALL_PATH%\lib\cog-jglobus-1.7.0.jar" goto nocogpath25
    goto cogpath
...
:cogpath
    ...
    java %OPTS% org.globus.tools.proxy.GridProxyInit %*
